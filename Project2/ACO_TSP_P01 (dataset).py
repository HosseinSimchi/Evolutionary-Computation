...
#Data_Set :  P01 is a set of 15 cities. It is NOT from TSPLIB. The minimal cost is 291.
...
print("P01 is a set of 15 cities")
minl = []
sw = []
varia = int(input("Enter your value:(Start with 500) "))
...
try:
    ...
    print('Oops!!, Please change the Threshold')
